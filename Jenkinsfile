...
sh (script:"ls -ltr")
sh (script:"cd /var/lib/jenkins/workspace/opsMathi_learnDevops_master-2RXKEKXSBX3VCQWUVPLYJNMPZCOAPDMDHDUZA6RKOTWJDRPE5TTQ/docker-springboot/target ls -ltr")
sh (script:"ls -ltr")
}