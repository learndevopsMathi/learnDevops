...
sh(script:"mvn -f /var/lib/jenkins/workspace/opsMathi_learnDevops_master-2RXKEKXSBX3VCQWUVPLYJNMPZCOAPDMDHDUZA6RKOTWJDRPE5TTQ/docker-springboot/pom.xml spring-boot:run ")
sh (script:"ls -ltr")
